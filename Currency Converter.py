...
def RealTimeCurrencyConversion():
    ...
    api_key = "cur_live_SpD5KPW5sTghRUZ0blP7fB3bdU7aQCWn7hOncgzC"

    # base_url variable store base urlxx`
    base_url = r"https://api.currencyapi.com/v3/latest?apikey=cur_live_SpD5KPW5sTghRUZ0blP7fB3bdU7aQCWn7hOncgzC&currencies=EUR%2CUSD%2CCAD"
